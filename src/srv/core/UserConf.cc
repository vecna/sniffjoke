	...
	ttlfocusmap(NULL)
{
	...
	compare_check_copy(runconfig.admin_address, sizeof(runconfig.admin_address), DEFAULT_ADMIN_ADDRESS, cmdline_opts.admin_address);
	...
	if (cmdline_opts.admin_port != 0)
		...
		runconfig.admin_port = DEFAULT_ADMIN_PORT;
