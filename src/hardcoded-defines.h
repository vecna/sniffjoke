...
#define SESSIONTRACKMAP_MANAGE_ROUTINE_TIMER 	1//300	/* (5 MINUTES */
#define TTLFOCUSMAP_MANAGE_ROUTINE_TIMER	1//3600	/* (1 HOUR) */
...
#define TTLFOCUSMAP_MEMORY_THRESHOLD		1//1024	/* 1024 DESTINATIONS */
